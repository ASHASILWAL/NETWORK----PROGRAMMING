...
public class AddressTypeEg {
	public static void main(String [] args)
	{
		try
		{
			...
			if(i.isLoopbackAddress()) //used to check whether the inetAddress is loop back address or not
				{
			...
			if(i.isMulticastAddress()) //used to check whether the inetAddress is an IP multi cast address or not
			{
